<?php
    ...
    $db = new DB_CONNECT();
    $insert_to_post_printing = "INSERT INTO printbook.post_printing(post_id, project_id, url_photo, support_removal, wedm, wedm_comment, blasting, blasting_time, blasting_type, blasting_comment, stress_id, hardening_id, tempering_id, solution_id, aging_id) VALUES('$post_id', '$project_id', '$url_photo', '$support_removal', '$wedm', '$wedm_comment', '$blasting', '$blasting_time','$blasting_type', '$blasting_comment', '$stress_id', '$hardening_id', '$tempering_id', '$solution_id', '$aging_id')";
