<?php
    ...
    $db = new DB_CONNECT();
    $insert_to_pre_printing = "INSERT INTO printbook.pre_printing(pre_printing_id, project_id, build_id, no_parts, printing_parameter, comment) VALUES('$pre_printing_id', '$project_id', '$build_id', '$no_parts', '$printing_parameter', '$comment')";
