<?php
    ...
    $db = new DB_CONNECT();
    $insert_to_stress_relieving = "INSERT INTO printbook.stress_relieving(stress_id, temperature, time, shielding_gas, comment) VALUES('$stress_id', '$temperature', '$time', '$shielding_gas', '$comment')";
